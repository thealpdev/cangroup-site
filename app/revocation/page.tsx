    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <main className="pt-32 pb-20 container mx-auto px-4 max-w-3xl">
                <h1 className="text-4xl font-serif font-bold mb-8">Widerrufsrecht</h1>
                <div className="prose prose-stone max-w-none leading-relaxed">
                    ...
                    <p>Um Ihr Widerrufsrecht auszuüben, müssen Sie uns (CANGROUP, Neustadt 8, 63654 Büdingen, E-Mail: info@cangroup.de, Telefon: +49 (0) 178 4057295) mittels einer eindeutigen Erklärung (z. B. ein mit der Post versandter Brief, Telefax oder E-Mail) über Ihren Entschluss, diesen Vertrag zu widerrufen, informieren. Sie können dafür das beigefügte Muster-Widerrufsformular verwenden, das jedoch nicht vorgeschrieben ist.</p>
                    ...
                    <ul className="list-none space-y-2 pl-0">
                        <li>– An CANGROUP, Neustadt 8, 63654 Büdingen, info@cangroup.de:</li>
